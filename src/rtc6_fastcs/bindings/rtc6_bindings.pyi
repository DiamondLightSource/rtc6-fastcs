...
__all__: list[str] = ['CardInfo', 'LaserMode', 'ListStatus', 'RtcConnectionError', 'RtcError', 'RtcListError', 'activate_scanahead_autodelays_list', 'add_arc_to', 'add_jump_to', 'add_laser_on', 'add_line_to', 'check_connection', 'clear_errors', 'close', 'config_list_memory', 'connect', 'execute_list', 'get_card_info', 'get_config_list', 'get_error', 'get_error_string', 'get_input_pointer', 'get_io_status', 'get_last_error', 'get_list_space', 'get_list_statuses', 'init_list_loading', 'list_nop', 'load_list', 'save_and_restart_timer', 'set_angle_list', 'set_end_of_list', 'set_firstpulse_killer_list', 'set_jump_speed_ctrl', 'set_laser_control', 'set_laser_delays', 'set_laser_mode', 'set_laser_pulses', 'set_mark_speed_ctrl', 'set_offset_xyz_list', 'set_scanahead_laser_shifts_list', 'set_scanahead_line_params_list', 'set_scanner_delays', 'set_sky_writing_para_list', 'set_wobbel_mode']
class CardInfo:
    @property
...
class LaserMode:
    ...
    __members__: typing.ClassVar[dict[str, LaserMode]]  # value = {'CO2': <LaserMode.CO2: 0>, 'YAG1': <LaserMode.YAG1: 1>, 'YAG2': <LaserMode.YAG2: 2>, 'YAG3': <LaserMode.YAG3: 3>, 'LASER4': <LaserMode.LASER4: 4>, 'YAG5': <LaserMode.YAG5: 5>, 'LASER6': <LaserMode.LASER6: 6>}
...
class ListStatus:
    ...
    __members__: typing.ClassVar[dict[str, ListStatus]]  # value = {'LOAD1': <ListStatus.LOAD1: 0>, 'LOAD2': <ListStatus.LOAD2: 1>, 'READY1': <ListStatus.READY1: 2>, 'READY2': <ListStatus.READY2: 3>, 'BUSY1': <ListStatus.BUSY1: 4>, 'BUSY2': <ListStatus.BUSY2: 5>, 'USED1': <ListStatus.USED1: 6>, 'USED2': <ListStatus.USED2: 7>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
def activate_scanahead_autodelays_list(mode: typing.SupportsInt) -> None:
    ...
    """
def add_arc_to(x: typing.SupportsInt, y: typing.SupportsInt, angle: typing.SupportsFloat) -> None:
    ...
...
def close(arg0: typing.SupportsInt) -> None:
    ...
    """
def config_list_memory(list_1_mem: typing.SupportsInt, list_2_mem: typing.SupportsInt) -> None:
    """
...
def set_firstpulse_killer_list(length: typing.SupportsInt) -> None:
    """
    configure first-pulse killer for list
    """
...
def set_laser_control(settings: typing.SupportsInt) -> None:
    ...
    """
def set_laser_delays(laser_on_delay: typing.SupportsInt, laser_off_delay: typing.SupportsInt) -> None:
    """
...
def set_scanahead_line_params_list(cornerScale: typing.SupportsInt, endScale: typing.SupportsInt, accScale: typing.SupportsInt) -> None:
    ...
    """
def set_scanner_delays(jump: typing.SupportsInt, mark: typing.SupportsInt, polygon: typing.SupportsInt) -> None:
    """
...
def set_sky_writing_para_list(timelag: typing.SupportsFloat, laserOnShift: typing.SupportsInt, nPrev: typing.SupportsInt, nPost: typing.SupportsInt) -> None:
    ...
    """
def set_wobbel_mode(transversal: typing.SupportsInt, longditudinal: typing.SupportsInt, freq: typing.SupportsFloat, mode: typing.SupportsInt) -> None:
    """
